...
const transactions = [
  { id: '1', type: 'earning', description: 'Хүргэлт #ORD-098', amount: 12000, time: '14:30' },
  { id: '2', type: 'earning', description: 'Хүргэлт #ORD-097', amount: 18000, time: '11:20' },
  { id: '3', type: 'bonus', description: 'Хурдан хүргэлтийн урамшуулал', amount: 5000, time: '11:25' },
  { id: '4', type: 'earning', description: 'Хүргэлт #ORD-096', amount: 6000, time: '09:45' },
  { id: '5', type: 'withdrawal', description: 'Хасалт - Банк руу', amount: -50000, time: 'Өчигдөр' },
];
...
export default function DriverEarnings() {
  ...
  const getEarnings = () => {
    switch (selectedPeriod) {
      case 'today': return driverStats.todayEarnings;
      case 'week': return driverStats.weekEarnings;
      case 'month': return driverStats.monthEarnings;
      default: return driverStats.todayEarnings;
    }
  };
      ...
      <section className="px-4 -mt-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-card rounded-xl p-4 shadow-elevated">
            ...
            <p className="text-2xl font-bold text-foreground">{driverStats.totalDeliveries}</p>
          ...
          <div className="bg-card rounded-xl p-4 shadow-elevated">
            ...
            <p className="text-2xl font-bold text-foreground">{driverStats.completionRate}%</p>
              ...
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                ...
                {transaction.type === 'withdrawal' ? (
                  ...
                  <ArrowUpRight className={`w-5 h-5 ${
                    transaction.type === 'bonus' ? 'text-accent' : 'text-success'
                  }`} />
                )}
              </div>
