    ...
    const load = async () => {
      ...
      try {
        const res = (await supabase
          .from("delivery_tasks")
          .select(`*, order:orders(id, total_amount, store_id, user_id)`)
  ...
  return (
    <AppLayout>
      ...
      <div className="h-full flex flex-col justify-between">
        <div className="relative h-full bg-gradient-to-b from-muted to-muted/50">
        ...
        <motion.div
          ...
          className="bg-card absolute left-0 right-0   rounded-t-3xl bottom-0 -mt-6 z-10 shadow-elevated overflow-hidden">
          {/* Handle */}
          <button
